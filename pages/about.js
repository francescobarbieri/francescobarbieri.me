    ...
    return (
        <>
            <Head>
                ...
                <link rel="canonical" href="https://francescobarbieri.blog/about"/>
                <link rel="sitemap" type="application/xml" href="/sitemap.xml" />
                
                <meta property="og:site_name" content="About me | Francesco Barbieri's Blog"/>
                <meta property="og:type" content="website"/>
                <meta property="og:title" content="About me | Francesco Barbieri's Blog"/>
                <meta property="og:description" content="Blogging about programming, tech, actuality and human factors."/>
                <meta property="og:url" content="https://francescobarbieri.blog/about"/>
                
                <meta name="twitter:card" content="summary"/>
                <meta name="twitter:title" content="About me | Francesco Barbieri's Blog"/>
                <meta name="twitter:description" content="Blogging about programming, tech, actuality and human factors."/>
                <meta name="twitter:url" content="https://francescobarbieri.blog/about"/>
                ...
                <main className="wrapper">
                    ...
                    <section>
                        <div className={styles.container}>
                            ...
                            <h3 className={[robotoSlab.className, styles.subsection].join(" ")}>
                                Why do you blog?
                            </h3>
                            <p className={styles.aboutText}>
                                ...
                                <br/><br/>
                                In this blog I'm going to publish tech, coding, finance, investing and actuality posts.
                                <br/><br/>
                    ...
                    <section>
                        <div className={styles.container}>
                            ...
                            />
                            <p className={styles.aboutText}>
                                This list was last updated in <b>February 2023.</b>
                            </p>
